...
def arg_parser():
    ...
    # main config
    parser.add_argument('-n', '--n_customer', metavar='N', type=int, default=80,
...
def test_parser():
    ...
    parser.add_argument('-p', '--path', metavar='P', type=str, default='Weights/VRP50_epoch25.pt',
                        help='Weights/VRP***_epoch***.pt, pt file required')
    parser.add_argument('-t', '--txt', metavar='T', type=str, default='data/n50d3c3s4.json',
