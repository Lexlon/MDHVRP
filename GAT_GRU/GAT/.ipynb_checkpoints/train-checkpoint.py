...
def train(cfg):
    ...
    def get_results(train_loss_results, train_cost_results, val_cost, filename=None, plots=True):
        ...
        df.to_csv('learning_scalewithgru_{}_{}.csv'.format(cfg.n_customer,cfg.batch*cfg.batch_steps), index=False)
        if plots:
    ...
    filename_for_results = 'n_{}, d_{}, sample{}'.format(cfg.n_customer, cfg.n_depot,cfg.batch*cfg.batch_steps)
